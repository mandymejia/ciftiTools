...
```{r, fig.cap="Schaefer 100 parcellation", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5}
...
view_xifti_surface(xii, idx=1, title='Schaefer 100', cex.title=1.3)
```
...
```{r, fig.cap="Schaefer 100 on midthickness surface", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5}
xii <- add_surf(xii, "midthickness", "midthickness")
view_xifti_surface(xii, title='Midthickness surface', cex.title=1.3)
```

`remove_xifti` removes a brain structure.

```{r, fig.cap="Removed right cortex", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=2.5}
xii <- remove_xifti(xii, c("cortex_right", "surf_right"))
view_xifti_surface(xii, title='Left cortex only', cex.title=1.3)
```

`transform_xifti` applies a function to the data values. Let's isolate and view the frontal pole cortex.

```{r, fig.cap="Plotting one parcel", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=2.5}
...
view_xifti_surface(xii, title='"FPole" parcel', cex.title=1.3)
```
