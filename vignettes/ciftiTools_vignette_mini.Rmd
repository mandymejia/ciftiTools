...
```{r, fig.cap="Schaefer 100 parcellation", fig.height=2.1, fig.width=2.5}
...
view_xifti_surface(xii, idx=1, title='Schaefer 100', fname=xii_plt)
knitr::include_graphics(xii_plt, dpi=200)
```
...
```{r, fig.cap="Plotting the FPole parcel", fig.height=2, fig.width=1.3}
...
xii_plt <- tempfile(fileext=".png")
view_xifti_surface(xii, fname=xii_plt)
knitr::include_graphics(xii_plt, dpi=200)
```
