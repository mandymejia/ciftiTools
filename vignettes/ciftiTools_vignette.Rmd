...
```{r, fig.cap="dscalar; using NA values to selectively color", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
...
```{r, fig.cap="Lessening the shadows", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
view_xifti_surface(
...
```{r, fig.cap="Exact coloring, by disabling shadows and color smoothing", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
view_xifti_surface(
...
```{r, fig.cap="Smoothed CIFTI, default palette", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
...
```{r, fig.cap="Smoothed CIFTI, RColorBrewer palette", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
# Let's demonstrate the ability to use RColorBrewer palettes!
plot(
  read_cifti(file.path(out_dir, smoothed_xii_fname)), 
  surfL=surfL_fname, surfR=surfR_fname, 
...
```{r, rgl=TRUE, format="jpg", fig.cap="Inflated surface", fig.height=4.2, fig.width=2.75}
# Writing
...
```{r, fig.cap="Two alternative surfaces", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
xii <- as.xifti(
...
```{r, rgl=TRUE, fig.cap="Surface with vertices drawn in blue", format="jpg", fig.height=4.2, fig.width=2.75}
# Recall that surf was resampled to 2k
plot(surf, vertex_size=3, vertex_color="blue")
```

```{r, rgl=TRUE, fig.cap="Surface with edges drawn in black", format="jpg", fig.height=4.2, fig.width=2.75}
...
```{r, rgl=TRUE, fig.cap="500 evenly-sampled vertices", format="jpg", fig.height=4.2, fig.width=2.75}
...
```{r fig.cap="Schaefer 400 parcellation", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
...
```{r fig.cap="Median parcel value", rgl=TRUE, format="jpg", fig.height=4.2, fig.width=5.5}
