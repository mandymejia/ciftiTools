...
#   dscalar = file.path("../inst/extdata", "Conte69.MyelinAndCorrThickness.6k_fs_LR.dscalar.nii"),
#   dlabel = file.path("../inst/extdata", "Conte69.parcellations_VGD11b.6k_fs_LR.dlabel.nii"),
#   dscalar_ones = file.path("../inst/extdata","ones_1k.dscalar.nii")
# )
...
* `color_mode` specifies the nature of the data values: `"sequential"` (default), `"qualitative"` and `"diverging"`.
...
```{r, fig.cap=".dscalar file; second column; Second time point; diverging palette", rgl=TRUE, format="png", fig.height=6, fig.width=7.5}
view_xifti_surface(cii, idx=2, zlim=c(1,5))
```

```{r, fig.cap=".dlabel file; first label; palette from label metadata", rgl=TRUE, format="png", fig.height=6, fig.width=7.5}
# Interactively, set qualitative_colorlegend to TRUE to view a color legend that displays the label names.
dlabel <- view_xifti_surface(read_cifti(cifti_fnames["dlabel"]), qualitative_colorlegend=FALSE, colorlegend_ncol=5)
```
