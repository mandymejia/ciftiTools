...
By default, `read_cifti` will read-in all existing brainstructures. Set `brainstructures=c("left","right")`, for example, to read in just the left and right cortex data. The full set of choices for brainstructures is any combination of `"left"`, `"right"` and `"subcortical"`, or `"all"` for all three.
