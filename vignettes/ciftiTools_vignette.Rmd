...
knitr::include_graphics(view_xifti_surface(
  cii, zlim=c(1,2), mode='image', fname=file.path(out_dir, "xifti_1.png")
))
```

```{r}
knitr::include_graphics(view_xifti_surface(
  cii, idx=2, zlim=c(1,5), color_mode='diverging', mode='image', fname=file.path(out_dir, "xifti_2.png")
))
```
...
```{r}
knitr::include_graphics(plot(make_surf(surfR_fname), hemisphere="right", mode="image", fname=file.path(out_dir, "surf_1.png")))
```
...
knitr::include_graphics(view_xifti_surface(cii_new, mode="image", fname=file.path(out_dir, "xifti_3.png")))
```
...
plot(
  ...
  zoom=7/10, bg="#d4edf5", cex.title=1.25, title=".dtseries resampled to 6k", zlim=c(0,2)
)
```
...
separated_files = separate_cifti(cifti_fnames$dscalar_ones, brainstructures="all", cortexL_fname="my_left_cortex.func.gii", write_dir=tempdir())
...
knitr::include_graphics(plot(
  read_cifti(smoothed_cii_fname), surfL=surfL_fname, surfR=surfR_fname, mode="image", fname=file.path(out_dir, "xifti_4.png")
))
```
