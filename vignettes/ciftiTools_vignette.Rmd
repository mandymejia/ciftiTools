...
view_xifti_surface(cii, idx=1, zlim=c(1,2), widget=FALSE, title="Sequential", cex.title=1.2)
```

```{r, fig.cap=".dscalar file; second column; diverging palette", rgl=TRUE, format="png", fig.height=4.2, fig.width=5}
view_xifti_surface(
  cii, idx=2, zlim=c(1,5), color_mode = "diverging", widget=FALSE, 
  title="Diverging", cex.title=1.2
)
```
...
dlabel <- view_xifti_surface(
  ...
  title="Qualitative", cex.title=1.2
)
```
...
plot(small_surf, edge_color="black", vertex_size=3, widget=FALSE)
```
