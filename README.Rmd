...
![ciftiTools graphical summary](README_media/ciftiTools_summary.jpg){width=70%}

!["xifti" object structure](README_media/xifti_structure.png){width=70%}

![Surfaces comparison. The "very inflated", "inflated", and "midthickness" surfaces are included in ciftiTools. See the data acknowledgement section at the bottom of this README.](README_media/surf_tour.gif){width=70%}
...
Acknowledgement statement according to the [Data Use Terms](https://www.humanconnectome.org/study/hcp-young-adult/document/wu-minn-hcp-consortium-open-access-data-use-terms) for the default surfaces included in `ciftiTools`:
