...
![Surfaces comparison. The "very inflated", "inflated", and "midthickness" surfaces are included in ciftiTools through the function `load_surf`. See the data acknowledgement section at the bottom of this README.](man/figures/surf_tour.gif){width=25%}
...
![Lit surface plot](man/figures/vxs_lit.jpg){width=14%} ![Unlit surface plot](man/figures/vxs_unlit.jpg){width=14%}
