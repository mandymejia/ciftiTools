...
If you use `ciftiTools`, please cite our [paper](https://doi.org/10.1016/j.neuroimage.2022.118877). You can also obtain citation information from within R like so:
...
![Lit surface plot](README_media/vxs_lit.png){width=20%} ![Unlit surface plot](README_media/vxs_unlit.png){width=20%}
