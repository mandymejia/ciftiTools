...
#'
#' Below is a list of \code{"xifti"}-related functions. (See 
#'  \code{library(help="ciftiTools")} for a complete list of user functions.)
#' 
#' \itemize{
#'  \item{\code{make_xifti}:}{ Create one from data.}
#'  \item{\code{newdata_xifti}:}{ Replace the data.}
