...
#' @export
#'
cifti_make <- function(cortex_left=NULL, cortex_right=NULL, subcortical=NULL, mask=NULL, labels=NULL){
  ...
  cifti_out <- vector('list', 4)
  class(cifti_out) <- 'cifti'
  names(cifti_out) <- c("CORTEX_LEFT","CORTEX_RIGHT","VOL","LABELS")
