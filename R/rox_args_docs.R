...
#'  is greater than one, an rgl widget will be opened with a slider to control
#'  the \code{idx} being shown. But, the layout will be arranged differently,
#'  in a less-optimal way (the widget does not support subplots).
#'
